...
const WeatherApp = () => {
  ...
  const backgroundImages = {
    ...
    Clouds: "linear-gradient(to right, #79f2fc, #56bbc4)",
    Rain: "linear-gradient(to right, #79f2fc, #56bbc4)",
    Snow: "linear-gradient(to right, #79f2fc, #56bbc4)",
    Haze: "linear-gradient(to right, #79f2fc, #56bbc4)",
    Mist: "linear-gradient(to right, #79f2fc, #56bbc4)",
  };
